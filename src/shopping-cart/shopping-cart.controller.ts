...
export class ShoppingCartController {
  ...
  updateCount(
    ...
    return this.shoppingCartService.updateCount(count, setId);
  }
  ...
  updateTotalPrice(
    ...
    return this.shoppingCartService.updateTotalPrice(total_price, setId);
  }

  @UseGuards(AuthenticatedGuard)
  @Delete('/one/:id')
  removeOne(@Param('id') setId: string) {
    return this.shoppingCartService.remove(setId);
  }
